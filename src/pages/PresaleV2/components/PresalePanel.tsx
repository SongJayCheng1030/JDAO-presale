          ...
          <div className="presaleV2-info-grid">
            {!isPresaleLive ? null : (
              <div className="presaleV2-info-board">
                ...
                <Countdown
                  date={presaleInfo.endDateTime?.getTime()}
                  renderer={({ days, hours, minutes, seconds, completed }) => {
                    return (
                      <div className="presaleV2-info-value presaleV2-countdown">
                        <div>
                          <div>{days.toString().padStart(2, '0')}</div>
                          <div className="presaleV2-countdown-time-name">
                            Days
                          </div>
                        </div>
                        <img src={CountdownSeparatorImg} alt="" />
                        <div>
            ...
            <div className="presaleV2-info-board">
              ...
              <div className="presaleV2-info-value presaleV2-info-currency">
                <img src={UsdcImg} alt="" />
                <span>
                  {presaleInfo.usdcRaised?.toLocaleString(undefined, {
                    maximumFractionDigits: 2,
                    minimumFractionDigits: 2,
                  }) ?? 'N/A'}
                </span>
            ...
            <div className="presaleV2-info-board">
              ...
              <div className="presaleV2-info-value presaleV2-info-currency">
                ...
                <span>
                  {presaleInfo.buyRate
                    ? (1 / presaleInfo.buyRate).toFixed(2)
                    : 'N/A'}
                </span>
              </div>
            </div>
            ...
            >
              ...
              <div className="presaleV2-info-value">
                {presaleInfo.joysForSale?.toLocaleString() ?? 'N/A'}
              </div>
            </div>
          </div>
        </div>
