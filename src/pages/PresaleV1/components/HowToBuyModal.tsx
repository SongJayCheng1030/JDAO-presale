        ...
        <div className={Styles.prohibitionPopUp}>
          ...
          <div className={Styles.text}>
            ...
            <ol className={Styles.textDescription}>
              ...
              <li>Enter in the desired amount of $JOY you would like to purchase</li>
              <li>Select between USDC or USDT as a payment method</li>
              ...
              <li>Receive $xJOY in your wallet (auto-staked version of $JOY token)</li>
