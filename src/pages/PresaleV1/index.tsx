  ...
  return (
    <div className="presale-page">
      <Helmet>
        <meta charSet="utf-8" />
        <title>
          {SALE_TYPE === '0' ? 'Seed Round' : 'Private'} Presale | Joystick
        </title>
        <meta property="og:url" content="https://seed.joystickgames.com/" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Pre Sale | Joystick" />
        <meta property="og:site_name" content="Joystick" />
        <meta
          property="og:description"
          content="Private pre sale for Joystick. If you know, you know."
        />
        <meta
          property="og:image"
